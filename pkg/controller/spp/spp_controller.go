...
import (
	...
	sppv1alpha1 "github.com/yasufum/spp-operator/pkg/apis/spp/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &sppv1alpha1.Spp{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func (r *ReconcileSpp) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Fetch the Spp instance
	instance := &sppv1alpha1.Spp{}
	...
	// Set Spp instance as the owner and controller
...
func newPodForCR(cr *sppv1alpha1.Spp) *corev1.Pod {
